function onClickButtonAddFavorites(e) {
  console.log(e.target.parentElement.parentElement.parentElement.getAttribute('data-product-id'))
  // console.log(e.target.parentElement.parentElement.parentElement) 
  const id = e.target.parentElement.parentElement.parentElement.getAttribute('data-product-id')
...
function onChangeSorted(e) {
  if (e.target.value === 'byPriceASC'){
    ...
    handlegetslice20AndSortFromCheap()
    // handleSortedFromCheap()
  }
